...
LEVELS_ENVIROMENT = {
    ...
    "level2": [
        ...
        [5, {'name': 'small_bottle', 'type': 'terrain', 'size': (100, 100),
                  'color': colors.rock_brown, 'image': TERRAIN_CACHE['small_bottle'].copy()}],
        [5, {'name': 'funny_chair', 'type': 'terrain', 'size': (100, 100),
                  'color': colors.mundane_orange, 'image': TERRAIN_CACHE['funny_chair'].copy()}],
        [3, {'name': 'jukebox', 'type': 'terrain', 'size': (140, 140),
             'color': colors.maroon, 'image': TERRAIN_CACHE['jukebox'].copy()}],
        [3, {'name': 'arcade_machine', 'type': 'terrain', 'size': (140, 140),
             'color': colors.burnt_yellow, 'image': TERRAIN_CACHE['arcade_machine'].copy()}],
    ],
    "level3": [
